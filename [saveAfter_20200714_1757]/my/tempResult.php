...
require_once  $_SERVER['DOCUMENT_ROOT'].'/common/library/_nicePay/lib/nicepay/web/NicePayWEB.php';
require_once  $_SERVER['DOCUMENT_ROOT'].'/common/library/_nicePay/lib/nicepay/core/Constants.php';
require_once  $_SERVER['DOCUMENT_ROOT'].'/common/library/_nicePay/lib/nicepay/web/NicePayHttpServletRequestWrapper.php';
/*
*******************************************************
* <결제 결과 설정>
...
<html>
<head>
	<title>NICEPAY VBANK RESULT(UTF-8)</title>
	<meta charset="UTF-8">
...
<div class="payfin_area">
	<div class="top">NICEPAY VBANK RESULT(UTF-8)</div>
	<div class="conwrap">
		<div class="con">
