...
var floatPosition = parseInt($(".separatedRight.rightFloat.innerFloat.goodsInfoGroup").css('top'));

var limitTop = $(".findPageTab.goodsInfoTypeTab").offset().top;

var limitFooter = $('footer').position().top + 1000;
