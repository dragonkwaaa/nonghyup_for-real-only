...
$state 					=	$SubFunction->allTags($_GET['state']);
...
<div class="container">
	...
	<div class="contents">
		...
		<div class="section orderRegSect orderSpecMod">
			...
			<div class="mainTitle">주문 상세조회</div>
				...
				<ul class="regInfoList">
					...
					<li class="infoGroup">
						...
						<ul class="infoList">
							<li class="relative">
								<span>주문번호</span>
								<span class="absoluteR f_roboto" id="orderCode"></span>
							</li>
							<li class="relative">
								<span>주문일자</span>
							...
							<li class="relative">
								<span>주문자 연락처</span>
								<span class="absoluteR f_roboto" id="ordererMobile"></span>
							</li>
							<li class="relative">
								<span>주문자 이메일</span>
					...
					<li class="infoGroup">
						...
						<ul class="infoList payMentInfoList">
							<li class="relative">
								<span>총 주문금액</span>
								<span class="absoluteR f_robotoBold" id="orgAmount"></span>
							</li>
					<!--		<li class="relative">
								<span>총 할인금액</span>
							...
							<li class="relative">
								<span>총 결제금액</span>
								<span class="absoluteR totalPriceText f_bold f_robotoBold" id="amount"></span>
							</li>
							<li class="relative">
								<span>결제수단</span>
					...
					<li class="infoGroup">
						...
						<ul class="infoList">
							<li class="relative">
								<span>받으시는 분</span>
								<span class="absoluteR" id="receiveName">강동원</span>
							</li>
							<li class="relative">
								<span>우편번호</span>
								<span class="absoluteR f_roboto" id="receiveZip">0000</span>
							</li>
							<li class="relative addressGroup">
								<span>주소</span>
								<span class="absoluteR" id="receiveAddr">서울특별시 마포구 마포대로 36 한신건물 2층 </span>
							</li>
							<li class="relative">
								<span>휴대전화</span>
								<span class="absoluteR" id="receiveMobile">010-1234-5678</span>
							</li>
							<li class="relative">
								<span>배송메세지</span>
								<span class="absoluteR" id="deliveryMsg">안전하게 배송해주세요~</span>
							</li>
						</ul>
					</li>
					<li>
...
<script src="/order/js/orderSpec.js"></script>
